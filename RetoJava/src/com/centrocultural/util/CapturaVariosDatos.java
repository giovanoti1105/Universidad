 ...
 * 
 */
public class CapturaVariosDatos {
	/**
	...
	/**
	 * The flag to indicate whether to clear the input lines or not after the
	 * getInputs method is called.
	 */
	 ...
	 * 
	 * @param owner
	 *            the owning Frame object
	 * @param size
	 *            the number of input lines
	 */
	public CapturaVariosDatos(Frame owner, int size) {
	...
	/**
	 * Constructs a MultiInputBox with the owner frame and labels for input
	 * lines.
	 * 
	 * @param owner
	 *            the owning Frame object
	 * @param labels
	 *            the array of String for input line labels
	 */
	public CapturaVariosDatos(Frame owner, String[] labels) {
	...
	/**
	 * Returns the input values entered by the user. If the user clicks the
	 * close box or the Cancel button, NO_ITEM is returned. In this case, a
	 * subsequent call to isCanceled will return true. If the user clicks the Ok
	 * button, an array of Sring is returned. For those input lines that contain
	 * no input value, the corresponding element in the array is an empty
	 * string.
	 * 
	 ...
	 * 
	 * @param label
	 *            an array of String for input line labels
	 */
	...
	/**
	 * Sets the reset flag. Pass true to clear the input fields after the
	 * getInputs method is called. It is useful to set the flag to false, so the
	 * input fields are not reset when you enter a number of similar data.
	 * Default is true so the input fields are cleared after each appearance of
	 * this dialog.
	 * 
	 * @param option
	 *            pass 'true' to reset the input fields
	 */
	...
	/**
	 * Sets the value to the input line at the index position. This method is
	 * useful to set default input values so the user gets an hint on the type
	 * of values expected in the input lines. This method does nothing when the
	 * index value is invalid.
	 * 
	 * @param index
	 *            the position of the input line to set the value
	 * @param value
	...
	/**
	 * Creates the content panel. This panel becomes the content portion of this
	 * dialog.
	 */
	private void createContentPanel() {
		JPanel tituloPanel = new JPanel();
		JPanel integradorPanel = new JPanel();
		
		tituloPanel.add(new JLabel(this.getMessage().toString()));
		...
		integradorPanel.setLayout(new BoxLayout(integradorPanel, BoxLayout.X_AXIS));
		integradorPanel.add(promptPanel);
		integradorPanel.add(inputPanel);
		
		contentPanel = new JPanel();
		contentPanel.setLayout(new BoxLayout(contentPanel, BoxLayout.Y_AXIS));
		contentPanel.add(tituloPanel);
		contentPanel.add(integradorPanel);
	}
	...
	private String[] getInputLines(int value) {
		...
		default:
			answer = NO_ITEM; // just in case; this case should
	...
	/**
	 * Displays this dialog using showOptionDialog and returns the user action.
	 * 
	 * return the id value of the user action
	 */
	private int showDialog() {
		return JOptionPane.showOptionDialog(getOwner(), contentPanel,
				getTitle(), JOptionPane.DEFAULT_OPTION, getIcon(), null,
