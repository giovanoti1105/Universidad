...
public class SistemaInformacion
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			//Usamos la herencia de la superclase para acceder a los métodos de lectura de datos
			do
				{
				opcion = sistemaInformacion.leerDatoTipoEntero
						("Ingrese la opción \n 1 para procesar los datos del empleado, "
					   + "\n 2 para los datos de la persona \n 3 para salir: ");
				if (opcion == 1)
					{
					...
					if (opcion == 2)
						...
						//Mostramos el reporte de status del estudiante
